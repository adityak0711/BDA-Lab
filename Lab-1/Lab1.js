...
db.Faculty.insert({id:4001,Name:"Pallavi", Department:"CSE", Position:"Professor", Subject:"BDA",Exp:10})
db.Faculty.insert({id:4002,Name:"Nandini", Department:"CSE", Position:"Professor", Subject:"MMC",Exp:12})
db.Faculty.insert({id:4003,Name:"Umadevi", Department:"CSE", Position:"Professor", Subject:"COA",Exp:15})
db.Faculty.insert({id:4004,Name:"Vikrant", Department:"CSE", Position:"Professor", Subject:"DSR",Exp:9})

//Inserting records into COE
...
//Inserting records into Library
...
// Inserting records into Admission
...
//Inserting records into Festival
db.Festival.insert({id:56001,Event_Name: "Code Jam",Entry_Fee:50,Date:"16-10-2020",Prize_Money:1000,Contact:"9097861234"})
db.Festival.insert({id:56002,Event_Name: "Tresure Hunt",Entry_Fee:150,Date:"16-10-2020",Prize_Money:2000,Contact:"9097861232"})
db.Festival.insert({id:56003,Event_Name: "Hackathon",Entry_Fee:100,Date:"17-10-2020",Prize_Money:1500,Contact:"9097861287"})
db.Festival.insert({id:56004,Event_Name: "Mock Interview",Entry_Fee:50,Date:"17-10-2020",Prize_Money:1200,Contact:"9097861298"})

//Find Record in Student
